...
int main() {
    ...
    printf("Time taken to track var: %.2f seconds\n", (float)std::chrono::duration_cast<std::chrono::seconds>(var_track_end - var_track_start).count());
    ...
    var_track_start = std::chrono::high_resolution_clock::now();
    ...
    var_track_end = std::chrono::high_resolution_clock::now();
